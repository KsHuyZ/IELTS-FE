...
export default function ReadingTestInstruction() {
        ...
        <div className="h-full flex flex-col justify-between">
          <div className="mt-8 pl-56">
            ...
            <ul className="list-disc pl-6 space-y-2 text-lg">
              ...
              <li>
                The test contains <span className="font-bold">3 sections</span>{" "}
              ...
              <li>
                There is <span className="font-bold">no extra time</span> to
                transfer answers (write directly on the screen).
              </li>
