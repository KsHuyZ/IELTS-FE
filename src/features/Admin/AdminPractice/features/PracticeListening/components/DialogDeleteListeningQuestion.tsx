import { deleteListeningPracticeQuestion, deletePracticeQuestion } from "@/api/AdminAPI/practice";
...
const DialogDeleteListeningQuestion = ({
  openDeleteQuestion,
  id,
  ...
  const handleDelete = async () => {
    setIsLoading(true);
    try {
      await deleteListeningPracticeQuestion(id);
    } catch (error) {
    } finally {
...
export default DialogDeleteListeningQuestion;
